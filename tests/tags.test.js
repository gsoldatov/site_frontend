...
/*
TODO
+ load page with fetch error:
    + error message is displayed;
    + buttons are not enabled;
    + pagination is not displayed;
+ page load and pagination:
    + load page 1 of 1 => no pagination;
    + load page 1 of 5:
        + check if no pagination exists during fetch;
        + check if pagination exists (p 1 2 3 4 5 n);
        + check if no gaps exist;
        + click on page 5 and check if the data is updated;
        + check if no gaps exist;
    + load page 1 of 10:
        + check if pagination exists (p 1 2 3 . 10 n);
        + click on button 3;
        + check if pagination exists (p 1 2 3 4 5 . 10 n);
        + click on button 5;
        + check if pagination exists (p 1 2 3 4 5 6 7 . 10 n);
        + click on next button;
        + check if page 6 is displayed;
        + click on prev button;
        + check if page 5 is displayed;
        + click on button 10;
        + check if page 10 is displayed;
- side menu buttons:
    + buttons during fetch:
        + check if all buttons are disabled during fetch;
    + add tag button:
        + click on add tag button;
        + check if redirects to /tags/:id;
    + select a tag and edit it;
        + load page;
        ...
        + click edit button;
        + check if redirects to /tags/:id;
    + select two tags and delete them:
        + load page;
        ...
        + click delete button;
        + click "Yes";
        + check if the tags are deleted from state and current page;
+ field menu buttons:
    + select/deselect:
        + load page 1 of 10;
        + wait for tags to be displayed;
        + select all;
        + check if selected elements are displayed;
    + sort:
        + load page 1 of 10;
        + click on sort desc;
        + check if tags are correctly displayed;
    ...
    + filter:
        + load page 1 of 10;
        + wait for tags to be displayed;
        + enter filter text which matches tags in mock;
        + check if tags are correctly displayed;
        + enter filter text which has no match in mock;
