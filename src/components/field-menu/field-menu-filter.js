...
/*
    Component which renders an input for filtering data in a FieldMenu component.
    FieldMenuFilterContainer should be used instead of this class to connect it to the state.
*/
