 ...
 */
export const getIsTDLDragAndDropEnabledSelector = objectID => state => !isFetchingObject(state) && ObjectsEditSelectors.editedOrDefaultSelector(objectID)(state).toDoList.sort_type === "default";
