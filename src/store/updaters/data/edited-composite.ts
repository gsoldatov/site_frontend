...
import { objectHasNoChanges } from "../../state-util/objects";
...
export class EditedCompositeUpdaters {
    ...
    static addNewSubobject(state: State, objectID: number, update: ParamsAddNewSubobject): State {
        ...
        const newEditedObject = getEditedObjectState({ object_id: subobjectID, is_published, owner_id });
    ...
    //  * 
    //  * TODO add typing when add/update fetches are typed.
    //  */
