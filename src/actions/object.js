...
export const loadAddObjectPage         = (forceReset = false) => ({ type: LOAD_ADD_OBJECT_PAGE, forceReset });
...
export const setCurrentObjectTags      = tagUpdates => ({ type: SET_CURRENT_OBJECT_TAGS, tagUpdates });
