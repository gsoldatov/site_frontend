...
// export const SET_OBJECTS_PAGINATION_FETCH = "SET_OBJECTS_PAGINATION_FETCH";
// export const SET_OBJECTS_ON_DELETE_FETCH = "SET_OBJECTS_ON_DELETE_FETCH";
...
// export const setObjectsPaginationFetch = (isFetching = false, fetchError = "", lastFetch = undefined) => { 
//     return {
//         type: SET_OBJECTS_PAGINATION_FETCH, 
...
// export const setObjectsOnDeleteFetch = (isFetching = false, fetchError = "", lastFetch = undefined) => { 
//     return {
//         type: SET_OBJECTS_ON_DELETE_FETCH, 
//         isFetching: isFetching, 
//         fetchError: fetchError,
//         lastFetch: lastFetch
//     };
...
//             dispatch(setObjectsPaginationFetch(true, ""));
...
//             }
//             dispatch(setObjectsPaginationFetch(false, "", "objectsPagination"));
//         }
//         catch(error) {
//             dispatch(setObjectsPaginationFetch(false, error.message, "objectsPagination"));
//         }
//     };
// };
...
//         try {
//             // Update fetch status
//             dispatch(setObjectsOnDeleteFetch(true, "", ""));
...
//             }
//             dispatch(setObjectsOnDeleteFetch(false, error, "objectsOnDelete"));
//         } catch (error) {
//             dispatch(setObjectsOnDeleteFetch(false, error.message, "objectsOnDelete"));
//         }
//     };
// };
